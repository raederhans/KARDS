...
export const UI_TEXT = {
  en: {
    ...
    help: {
      ...
      saveItems: [
        { title: "Automatic draft", body: "Keeps lightweight card data in this browser, but not uploaded artwork." },
        { title: "Project file", body: "Keeps the full editable card, including uploaded artwork." },
        { title: "Local card library", body: "Keeps reusable cards in one folder, but does not embed uploaded artwork." },
      ...
      referenceBody: "Selecting a reference row changes only the comparison card. Use artwork only changes the artwork. Load entire card replaces the current card.",
      ...
      tips: [
        ...
        "If folder saving is unavailable, use the browser download instead.",
        "Use a project file when you need to keep uploaded artwork for later editing.",
      ],
    },
    fieldPanel: {
      aria: "Card editor",
  ...
  zh: {
    ...
    help: {
      ...
      workspaceItems: [
        ...
        { title: "参考", body: "搜索、对比和应用内置参考卡。" },
      ],
      saveTitle: "选择合适的保存方式",
      saveItems: [
        { title: "自动草稿", body: "在当前浏览器保存轻量卡牌数据，但不保存上传的卡图。" },
        { title: "项目文件", body: "保存完整可编辑卡牌，包括上传的卡图。" },
        { title: "本地卡库", body: "在同一文件夹保存可重复使用的卡牌，但不嵌入上传的卡图。" },
        { title: "导出文件", body: "生成最终 PNG、JPG 或 PDF，不包含可继续编辑的项目数据。" },
      ],
      referenceTitle: "参考操作的效果不同",
      referenceBody: "选择参考卡行只会切换对比卡；“仅应用卡图”只替换卡图；“载入整张卡牌”会覆盖当前卡牌。",
